...
<body>
    ...
    <div class="page-container">
        <div class="text-c"> 日期范围：
            ...
            <input type="text" class="input-text" style="width:250px" placeholder="输入门店名称" id="" name="">
            <button type="submit" class="btn btn-success" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜门店</button>
        </div>
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="javascript:;" onclick="admin_add('添加门店','add','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加门店</a></span></div>
        <table class="table table-border table-bordered table-bg">
            <thead>
                <tr>
                    <th scope="col" colspan="9">门店列表</th>
                </tr>
                <tr class="text-c">
                    <th width="25">
            ...
            <tbody>
                ...
                <tr class="text-c">
                    ...
                    <td class="td-manage">
                        ...
                        @endif
                        <a title="编辑" href="javascript:;" onclick="admin_edit('门店编辑','/admin/store/edit?id=' + '{{$val -> id}}','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                        {{--<a title="门店图集" href="javascript:;" onclick="admin_edit('门店图集','/admin/venue/imgs?id=' + '{{$val -> id}}','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe613;</i></a>--}}
    ...
    */
    ...
    function admin_del(obj, id) {
        layer.confirm('确认要删除吗？', function(index) {
            $.ajax({
                type: 'POST',
                url: '/admin/store/del?id='+id+'&_token='+_token,
                dataType: 'json',
