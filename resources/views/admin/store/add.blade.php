    ...
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="门店名称" id="store_name" name="store_name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>门店地址：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="门店地址" id="address" name="address">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="保证金金额" id="security_money" name="security_money">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="status" type="radio" value="1" id="gender-1" checked>
                    <label for="gender-1">使用</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="gender-2" value="2" name="status">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <dev id="uploader-demo10">
                    ...
                    <input type="hidden" name="logo" class="selecti" value="" id="" />
                </dev>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <dev id="uploader-demo0">
                    ...
                    <dev class="filePicker" id="abc">选择图片</dev>
                    <input type="hidden" name="idcard_back_img" class="selecti" value="" id="" />
                </dev>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <dev id="uploader-demo1">
                    ...
                    <input type="hidden" name="idcard_font_img" class="selecti" value="" />
                </dev>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <dev id="uploader-demo2">
                    ...
                    <input type="hidden" name="license_img" class="selecti" value="" id="" />
                </dev>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <dev id="uploader-demo3">
                    ...
                    <dev class="filePicker">选择图片</dev>
                    <input type="hidden" name="signing_contract_img" class="selecti" value="" id="" />
                </dev>
            </div>
        </div>
        <!-- csrf值 -->
