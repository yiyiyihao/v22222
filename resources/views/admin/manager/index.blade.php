...
<body>
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
                ...
                <a href="javascript:;" onclick="admin_add('添加管理员','add','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span>  </div>
        <table class="table table-border table-bordered table-bg">
            ...
            <tbody>
                ...
                <tr class="text-c">
                    ...
                    <td>
                        @if(!empty($val->role))
                            @foreach($val->role as $va)
                                {{$va->role_name}}&nbsp&nbsp
                            @endforeach
                        @endif
                    </td>
                    ...
                    <td class="td-manage">
                        ...
                        @endif
                        <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','/admin/manager/edit?id={{$val->id}}','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
