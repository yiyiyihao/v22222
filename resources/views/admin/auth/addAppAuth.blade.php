	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="权限名称" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				...
				<div class="radio-box">
					<input type="radio" id="is_nav-2" value="0" name="is_nav">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<dev id="uploader-demo">
					<dev id="fileList" class="uploader-list"></dev>
					<dev id="filePicker">选择图片</dev>
				</dev>
			</div>
		</div>
		<!-- csrf值 -->
		{{csrf_field()}}
		<input type="hidden" name="img" value="" id="avatar" />
		<div class="row cl">
...
<script type="text/javascript" src="/admin/js/webuploader2.js"></script>
<script type="text/javascript">
    $(function() {
