...
$(function(){
	...
	var str="<div class='select_time' style='display:none;' >"
				...
				+"        <div class='box'>"
				+"            <div class='hours sp1'><div class='tit'>小时<span>×</span></div><p class='clearfix'>"+hours+"</p></div>"
				+"            <div class='hours sp2'><div class='tit'>分钟<span>×</span></div><p class='clearfix'>"+minites+"</p></div>"
				+"            <div class='hours sp3'><div class='tit'>秒钟<span>×</span></div><p class='clearfix'>"+second+"</p></div>"
